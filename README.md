...
## フォークリポジトリ作成者による追記事項
**事前学習のときにはリンク先のファイルを参考にしてください**:
[Qwen2.5モデルの学習ガイド](/docs/source_ja/model_training_guide.md)
